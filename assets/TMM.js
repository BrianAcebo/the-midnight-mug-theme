...
document.addEventListener("DOMContentLoaded", () => {
  ...
  (() => {
              ...
              "ease-in-out": [
                ...
                function (a2, b2, c2, d2) {
                  var e2 = (a2 /= d2) * a2,
                    f2 = e2 * a2;
                  return (
                    b2 + c2 * (2 * f2 * e2 + -5 * e2 * e2 + 2 * f2 + 2 * e2)
                  );
                },
              ],
              linear: [
              ...
              "ease-in-out-back": [
                ...
                function (a2, b2, c2, d2, e2) {
                  return (
                    void 0 === e2 && (e2 = 1.70158),
                    (a2 /= d2 / 2) < 1
                      ? (c2 / 2) * a2 * a2 * (((e2 *= 1.525) + 1) * a2 - e2) +
                        b2
                      : (c2 / 2) *
                          ((a2 -= 2) * a2 * (((e2 *= 1.525) + 1) * a2 + e2) +
                            2) +
                        b2
                  );
                },
            ...
            L = l(function (b2) {
                  ...
                  if ("object" == e3) {
                    ...
                    J(function () {
                      u2.call(g3, a2, function (a3) {
                        a3.active &&
                          ((j2 = true), (k2[a3.name] = a3.nextStyle));
                      }),
                        j2 && g3.$el.css(k2);
                    });
                  }
              ...
              function l2(a2) {
                ...
                "string" == typeof a2
                  ? ((b3 = {}), (b3[a2] = 1))
                  : (b3 =
                      "object" == typeof a2 && null != a2 ? a2 : this.props),
                  u2.call(this, b3, v2),
                  t2.call(this);
              }
              function m2(a2) {
              ...
              (a2.init = function (a3, b3, d3, e2) {
                ...
                (a2.fallback = function (a3) {
                  ...
                  (a3 = this.convert(a3, this.type)),
                    this.auto &&
                      ("auto" == c3 &&
                        (c3 = this.convert(this.get(), this.type)),
                      "auto" == a3 && (a3 = b2.call(this))),
                    (this.tween = new R({
                      from: c3,
                      to: a3,
        ...
        tmm.define(
          ...
          (module.exports = function ($) {
            ...
            api.ready = function () {
              ...
              var publishedDomain = $html.attr("data-tmm-domain") || "";
              if (
          ...
          (module.exports = function () {
            function applyFocusVisiblePolyfill(scope) {
              ...
              function onBlur(e) {
                ...
                if (e.target.hasAttribute("data-tmm-focus-visible")) {
    ...
    function outElastic(pos) {
      ...
      return (
        a * Math.pow(2, -10 * pos) * Math.sin(((pos - s) * (2 * Math.PI)) / p) +
        1
      );
    }
    ...
    var require_IX2Lottie = __commonJS({
      "packages/systems/ix2/plugins/IX2Lottie.js"(exports) {
        ...
        var getPluginDuration3 = (element, actionItem) => {
          ...
          return (
            parseFloat(element.getAttribute("data-default-duration")) * 1e3
          );
        };
        ...
        var createPluginInstance3 = (element) => {
          const instance = window.tmm.require("lottie").createInstance(element);
          instance.stop();
    ...
    function getQuerySelector({ id, selector }) {
      if (id) {
        ...
        if (id.indexOf(IX2_ID_DELIMITER2) !== -1) {
          ...
          const pageId = pair[0];
          nodeId = pair[1];
          if (pageId !== document.documentElement.getAttribute(tmm_PAGE2)) {
            return null;
          }
        }
      ...
      "packages/shared/render/plugins/BaseSiteModules/tmm-scroll.js"(
        ...
        tmm.define(
          ...
          (module.exports = function ($) {
            ...
            var rootTag = tmm.env("editor") ? ".tmm-editor-body" : "body";
            var headerSelector =
              "header, " +
              rootTag +
              " > .header, " +
            ...
            var localHrefSelector =
              'a[href*="#"]:not(.tmm-tab-link):not(' + emptyHrefSelector + ")";
            ...
            function reducedMotionEnabled() {
              return (
                document.body.getAttribute("data-tmm-scroll-motion") ===
            ...
            function setFocusable($el, action) {
              ...
              switch (action) {
                case "add":
                  ...
                  if (initialTabindex) {
                    $el.attr("data-tmm-tabindex-swap", initialTabindex);
                  } else {
                    $el.attr("tabindex", "-1");
                  }
                  break;
                case "remove":
                  initialTabindex = $el.attr("data-tmm-tabindex-swap");
                  if (initialTabindex) {
              ...
              $el.toggleClass("tmm-force-outline-none", action === "add");
            }
            ...
            function ready() {
              ...
              $doc.on(tmm_CLICK_SCROLL, localHrefSelector, validateScroll);
              $doc.on(tmm_CLICK_EMPTY, emptyHrefSelector, function (e) {
                e.preventDefault();
              });
          ...
          (module.exports = function ($, _) {
            ...
            function makeToggler(data, forceClose) {
              return debounce(function (evt) {
                if (data.open || (evt && evt.type === "tmm-close")) {
                  return close(data, {
                    forceClose,
                  });
                }
            ...
            function outside(data) {
              ...
              return debounce(function (evt) {
                ...
                if ($target.closest(".tmm-dropdown-toggle").length) {
                  return;
                }
            ...
            function moveOutside(data) {
              return debounce(function (evt) {
                ...
                if (isEventOutsideDropdowns) {
                  ...
                  var $editorOverlay = $(".tmm-editor-bem-EditorOverlay");
                  var isDropdownInEdition =
                    $editorOverlay.find(".tmm-editor-edit-outline").length ||
                    $editorOverlay.find(".tmm-editor-bem-RTToolbar").length;
                  if (
        ...
        tmm.define(
          ...
          (module.exports = function ($, _) {
            ...
            function addListeners() {
              ...
              const FOCUSED_VISIBLE_CLASS = "tmm--redirected-focus-visible";
            ...
            function initFileUpload(i, form) {
              ...
              var $defaultWrap = $el.find("> .tmm-file-upload-default");
              var $uploadingWrap = $el.find("> .tmm-file-upload-uploading");
              var $successWrap = $el.find("> .tmm-file-upload-success");
              var $errorWrap = $el.find("> .tmm-file-upload-error");
              var $input = $defaultWrap.find(".tmm-file-upload-input");
              var $label = $defaultWrap.find(".tmm-file-upload-label");
              var $labelChildren = $label.children();
              var $errorMsgEl = $errorWrap.find(".tmm-file-upload-error-msg");
              var $fileEl = $successWrap.find(".tmm-file-upload-file");
              var $removeEl = $successWrap.find(".tmm-file-remove-link");
              var $fileNameEl = $fileEl.find(".tmm-file-upload-file-name");
              var sizeErrMsg = $errorMsgEl.attr("data-tmm-size-error");
              var typeErrMsg = $errorMsgEl.attr("data-tmm-type-error");
              var genericErrMsg = $errorMsgEl.attr("data-tmm-generic-error");
              if (!inApp) {
          ...
          lightbox.show = function (index) {
            ...
            if (isConditionallyHidden(item)) {
              if (index < currentIndex) {
                ...
                index =
                  previousVisibleIndex > -1 ? previousVisibleIndex : index;
              } else {
      ...
      "packages/shared/render/plugins/Navbar/tmm-navbar.js"(exports, module) {
        ...
        tmm.define(
          ...
          (module.exports = function ($, _) {
            ...
            var inEditor;
            var inApp = tmm.env();
            var overlay = '<div class="tmm-nav-overlay" data-tmm-ignore />';
            var namespace = ".tmm-nav";
            var navbarOpenedButton = "tmm--open";
            var navbarOpenedDropdown = "tmm--nav-dropdown-open";
            var navbarOpenedDropdownToggle = "tmm--nav-dropdown-toggle-open";
            var navbarOpenedDropdownList = "tmm--nav-dropdown-list-open";
            ...
            function build(i, el) {
              ...
              data.dropdownToggle = data.menu.find(".tmm-dropdown-toggle");
              data.dropdownList = data.menu.find(".tmm-dropdown-list");
            ...
            function outside(data) {
              ...
              return function (evt) {
                ...
                if (
                  inEditor &&
                  $target.closest(".tmm-editor-bem-EditorOverlay").length
                ) {
                  return;
                }
