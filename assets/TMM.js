...
(() => {
  ...
  var require_tmm_lib = __commonJS({
    "packages/shared/render/plugins/BaseSiteModules/tmm-lib.js"(
      ...
      function bindModule(module1) {
        if (tmm.env()) {
          isFunction(module1.design) && $win.on("__tmm_design", module1.design);
      ...
      function unbindModule(module1) {
        isFunction(module1.design) && $win.off("__tmm_design", module1.design);
        isFunction(module1.preview) &&
      ...
      tmm.define(
        ...
        (module.exports = function ($) {
          ...
          function reducedMotionEnabled() {
            return (
              document.body.getAttribute("data-tmm-scroll-motion") === "none" ||
  ...
  var require_tmm_dropdown = __commonJS({
    "packages/shared/render/plugins/Dropdown/tmm-dropdown.js"(exports, module) {
      "use strict";
      var tmm = require_tmm_lib();
      ...
      tmm.define(
        ...
        (module.exports = function ($, _) {
          ...
          function build(i, el) {
            ...
            data.links = data.list.find("a:not(.tmm-dropdown .tmm-dropdown a)");
  ...
  var require_tmm_lightbox = __commonJS({
    "packages/shared/render/plugins/Lightbox/tmm-lightbox.js"(exports, module) {
      "use strict";
      var tmm = require_tmm_lib();
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".tmm-dark-slider-arrow.tmm-dark-slider-arrow_left",
                  selectorGuids: [
